...
class EmptyParameterNameValidatorTest {
    @Test
    void testValid() {
        final ErrorMessageDeclaration messageDeclaration = ErrorMessageDeclaration.builder().addParameter("test", "")
    ...
    @Test
    void testInvalid() {
        final ErrorMessageDeclaration messageDeclaration = ErrorMessageDeclaration.builder().addParameter("", "")
                .setPosition("myFile.java", 1).build();
        final List<Finding> findings = new EmptyParameterNameValidator().validate(List.of(messageDeclaration));
